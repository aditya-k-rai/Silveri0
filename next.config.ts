    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'X-DNS-Prefetch-Control', value: 'on' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' *.vercel-scripts.com *.vercel.com *.googleapis.com *.google.com *.gstatic.com *.googletagmanager.com https://checkout.razorpay.com",
              "style-src 'self' 'unsafe-inline' fonts.googleapis.com",
              "img-src 'self' data: blob: https: firebasestorage.googleapis.com *.firebasestorage.app lh3.googleusercontent.com images.unsplash.com *.razorpay.com",
              "font-src 'self' fonts.gstatic.com",
              "connect-src 'self' *.googleapis.com *.google.com *.firebaseio.com *.firebasestorage.app *.firebaseapp.com *.googletagmanager.com *.google-analytics.com *.analytics.google.com *.vercel.com *.vercel-insights.com wss://*.firebaseio.com api.postalpincode.in *.razorpay.com lumberjack.razorpay.com",
