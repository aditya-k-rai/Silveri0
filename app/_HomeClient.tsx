...
/**
 * Client-side portion of the homepage — everything below the hero. Splits
 * away from app/page.tsx so the hero section can stream as static HTML on
 * first paint and the heavy product/Firestore subscriptions only kick in
